...
{
    /// <inheritdoc />
    public partial class UpdateGoogleModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientBranches", x => new { x.ClientId, x.BranchId });
                    table.ForeignKey(
                        name: "FK_ClientBranches_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GitLabRepoUrl = table.Column<string>(type: "TEXT", nullable: true),
                    GoogleEventId = table.Column<string>(type: "TEXT", nullable: true),
                    GoogleCalendarId = table.Column<string>(type: "TEXT", nullable: true),
                    SyncStatus = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TodoTasks_TaskTypes_TaskTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalendarEmail = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskAssignments", x => new { x.TodoTaskId, x.UserId });
                    table.ForeignKey(
                        name: "FK_TaskAssignments_TodoTasks_TodoTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkLogId = table.Column<int>(type: "INTEGER", nullable: true),
                    UserId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Documents_WorkLogs_WorkLogId",
            ...
            migrationBuilder.InsertData(
                table: "TaskTypes",
                columns: new[] { "Id", "IsBase", "Name" },
                values: new object[,]
                {
                    { 1, true, "Sopralluogo" },
                    { 2, true, "Riparazione" },
                    { 3, true, "Installazione" },
                    { 4, true, "Manutenzione" },
                    { 5, false, "Sviluppo" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientBranches_BranchId",
